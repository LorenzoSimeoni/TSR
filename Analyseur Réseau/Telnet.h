...
#define TOWINDOWSIZE (u_char) 31 /* Window size option */
#define TOTERMINALSPEED (u_char) 32 /* Terminal speed*/
#define TOLINEMODE (u_char) 34 /* Line mode */
#define TONEWENVOPT (u_char) 39 /* New Environnement opts */
